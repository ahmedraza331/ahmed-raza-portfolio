...
export default function SectionHeading({ label, title, titleAccent, description }: SectionHeadingProps) {
  return (
    ...
    >
      <span className="inline-block px-4 py-1.5 rounded-full text-xs font-semibold tracking-wider uppercase  bg-[#C6A96B]/10 border border-[#C6A96B]/20 text-[#C6A96B] mb-4">
        {label}
      </span>

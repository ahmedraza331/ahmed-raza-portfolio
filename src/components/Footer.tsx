...
const socials = [
  ...
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/ahmed-raza-bb46a938b',
  },
  {
    icon: Mail,
    label: 'Email',
    href: 'mailto:sheikhahmednasir04@gmail.com',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="mt-8 pt-6 border-t border-white/[0.03] text-center">
          <p className="text-[10px] text-white/10">
            © {new Date().getFullYear()} Ahmed Raza. All rights
            reserved.
          </p>

          <p className="text-[9px] text-white/[0.06] mt-1">
            Ctrl + K to search · Terminal button in corner
          </p>
        </div>
      </div>
    </footer>
